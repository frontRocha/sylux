...
import { collection, query, where, getDocs, doc, deleteDoc, DocumentData, CollectionReference, Query, QuerySnapshot, DocumentReference, setDoc, updateDoc } from "firebase/firestore";
